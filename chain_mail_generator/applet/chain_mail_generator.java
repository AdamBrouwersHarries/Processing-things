...
public class chain_mail_generator extends PApplet {
...
public void draw(){
  ...
  loadPixels();
  int S = get(PApplet.parseInt(POINTX+directionX),PApplet.parseInt(POINTY+directionY));
  if(S == color(0,0,0)){
   S= color(250,250,250); 
  }
  float RED = red(S)-50;
  ...
  static public void main(String args[]) {
    PApplet.main(new String[] { "--present", "--bgcolor=#666666", "--stop-color=#cccccc", "chain_mail_generator" });
  }
}
