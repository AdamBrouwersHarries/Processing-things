...
public class Repulsor extends PApplet {
...
public void draw()
{
  ...
  for(int i = 0;i<pointcount;i++)
  {
    ...
    if(PApplet.parseInt(random(5000))==1)
    {
...
class Point
{
  ...
  public void _draw()
  {
    stroke(100,100,100);
    point(x,y);
    line(x,y+r,x+r*0.7f,y+r*0.7f);
    line(x+r*0.7f,y+r*0.7f,x+r,y);
    line(x+r,y,x+r*0.7f,y-r*0.7f);
    line(x+r*0.7f,y-r*0.7f,x,y-r);
    line(x,y-r,x-r*0.7f,y-r*0.7f);
    line(x-r*0.7f,y-r*0.7f,x-r,y);
    line(x-r,y,x-r*0.7f,y+r*0.7f);
    line(x-r*0.7f,y+r*0.7f,x,y+r);
  ...
  static public void main(String args[]) {
    PApplet.main(new String[] { "--bgcolor=#f0f0f0", "Repulsor" });
  }
}
